...
class TestEnglishWords(unittest.TestCase):
    ...
    def test_white_space_char(self):
        ...
        """
        self.assertEqual(
            self.word_extractor.extract_english_words("Hello world my name is Python"),
    ...
    def test_apostrophe_mark(self):
        ...
        """
        self.assertEqual(
            self.word_extractor.extract_english_words("You're not supposed to be here."),
    ...
    def test_numbers(self):
        ...
        """
        self.assertEqual(
            self.word_extractor.extract_english_words("A quirky, quick way to make an excellent point. It reminded me of CASIOSpk - when we used to type in 771077345 or more commonly 58008 into our calculators and turn them upside down to reveal the 'hilarious' results."),
